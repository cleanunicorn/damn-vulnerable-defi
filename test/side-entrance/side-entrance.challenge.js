...
const SideEntranceHacker = contract.fromArtifact('SideEntranceHacker');
...
describe('[Challenge] Side entrance', function () {
    ...
    it('Exploit', async function () {
        ...
        this.hacker = await SideEntranceHacker.new(this.pool.address, { from: attacker });

        await this.hacker.start({ from: attacker });
    });
